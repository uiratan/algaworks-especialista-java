...
public class Industria extends EmpresaFinanciavel { // implements ClienteFinanciavel {
	...
	public double calcularLimiteAprovado() {
		var limiteAprovado = getTotalFaturamento() * PERCENTUAL_FATURAMENTO_LIMITE_CREDITO;
