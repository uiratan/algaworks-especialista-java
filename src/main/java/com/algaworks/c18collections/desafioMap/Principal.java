package com.algaworks.c18collections.desafioMap;
...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        // TO DO Performance é mais importante (não garante a ordem das chaves)
//        Map<Estado, Cidade> capitais = new HashMap<>();

        // TO DO Performance é importante, mas precisa manter ordem de inserção das chaves
//        Map<Estado, Cidade> capitais = new LinkedHashMap<>();

        // TO DO Performance é menos importante e precisa manter a ordem natural das chaves
        ...
        // TO DO Iteração nas entradas do mapa (chave/valor)
